...
const styles = StyleSheet.create({
    ...
    aiBadge: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: 'rgba(168, 85, 247, 0.1)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 100 },
    aiBadgeText: { fontSize: 8, fontFamily: Typography.sansBold, color: '#c084fc', letterSpacing: 1 },
    title: { fontSize: 22, fontFamily: Typography.serifBold, color: 'white', marginBottom: 12 },
    summary: { fontSize: 15, fontFamily: Typography.sans, color: 'rgba(255,255,255,0.7)', lineHeight: 24, marginBottom: 20 },
    ...
    adviceLabel: { fontSize: 8, fontFamily: Typography.sansBold, color: 'rgba(192, 132, 252, 0.5)', letterSpacing: 1.5, marginBottom: 6 },
    adviceText: { fontSize: 13, fontFamily: Typography.sans, color: 'rgba(255,255,255,0.8)', lineHeight: 20 },
    disclaimer: { flexDirection: 'row', alignItems: 'center', gap: 6, opacity: 0.5 },
    disclaimerText: { fontSize: 7, fontFamily: Typography.sansBold, color: 'rgba(255,255,255,0.3)', letterSpacing: 0.5 },
