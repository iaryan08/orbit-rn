...
export const firebaseConfig = {
    ...
    // Use the canonical Firebase Storage bucket name so SDK uploads work reliably.
    // Console bucket ID: moonbetweenus-a817e.appspot.com
    storageBucket: process.env.EXPO_PUBLIC_FIREBASE_STORAGE_BUCKET || "moonbetweenus-a817e.appspot.com",
