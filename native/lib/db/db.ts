...
export async function initializeDatabase() {
    try {
        ...
        const tables = [
            ...
            `CREATE TABLE IF NOT EXISTS polaroids (id TEXT PRIMARY KEY, image_url TEXT NOT NULL, caption TEXT, created_at INTEGER, user_id TEXT, updated_at INTEGER);`,
            ...
            `CREATE TABLE IF NOT EXISTS bucket_list (id TEXT PRIMARY KEY, title TEXT NOT NULL, description TEXT, is_completed INTEGER DEFAULT 0, is_private INTEGER DEFAULT 0, created_at INTEGER, created_by TEXT NOT NULL, updated_at INTEGER);`,
            ...
            `CREATE TABLE IF NOT EXISTS profiles (id TEXT PRIMARY KEY, display_name TEXT, avatar_url TEXT, couple_id TEXT, partner_id TEXT, is_partner INTEGER DEFAULT 0, updated_at INTEGER);`
        ];
